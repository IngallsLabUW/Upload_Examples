...
MESOSCOPE_Ingalls_EddyTransect_Dec2021 <- read_csv("data_processed/MESOSCOPE_Ingalls_EddyTransect_Dec2021.csv")

## Preferences for handling the H20 in water/matrix, which is essentially a QC run?

## Info for lat, lon, time, depth
Metadata <- MESOSCOPE_Ingalls_EddyTransect_Dec2021 %>%
...
Full_Data <- MESOSCOPE_Ingalls_EddyTransect_Dec2021 %>%
